...
describe('QuizQuestion', () => {
  ...
  it('calls onQuestionClick when clicked', () => {
    ...
    render(
      <QuizQuestion {...defaultProps} onQuestionClick={mockOnQuestionClick} />
    );
  ...
  it('renders with long question text', () => {
    const longQuestion =
      'This is a very long question that might need to wrap to multiple lines and should still be displayed correctly within the nine-slice panel container.';
