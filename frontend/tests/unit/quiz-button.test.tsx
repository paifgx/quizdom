...
describe('QuizButton', () => {
  ...
  it('does not call onClick when disabled', () => {
    const mockOnClick = vi.fn();
    render(
      <QuizButton {...defaultProps} onClick={mockOnClick} disabled={true} />
    );
  ...
  it('applies disabled styling when disabled', () => {
    const { container } = render(
      <QuizButton {...defaultProps} disabled={true} />
    );
  ...
  it('applies interactive styling when not disabled', () => {
    const { container } = render(
      <QuizButton {...defaultProps} disabled={false} />
    );
  ...
  it('handles Enter key press', () => {
    const mockOnClick = vi.fn();
    const { container } = render(
      <QuizButton {...defaultProps} onClick={mockOnClick} />
    );
