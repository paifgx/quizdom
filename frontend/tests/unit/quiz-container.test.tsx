...
describe('QuizContainer', () => {
  ...
  it('calls onAnswerSelect when an answer button is clicked', () => {
    ...
    render(<QuizContainer {...defaultProps} onAnswerSelect={mockOnAnswerSelect} />)
  ...
  it('passes onQuestionClick to QuizQuestion component', () => {
    ...
    render(<QuizContainer {...defaultProps} onQuestionClick={mockOnQuestionClick} />)
  ...
  it('has responsive grid layout for answer buttons', () => {
    ...
    const answerGridContainer = container.querySelector('.grid.grid-cols-1.md\\:grid-cols-2')
  ...
  it('renders with different quiz data', () => {
    ...
    render(<QuizContainer quizData={differentQuizData} onAnswerSelect={vi.fn()} />)
  ...
  it('renders with single answer option', () => {
    ...
    render(<QuizContainer quizData={singleAnswerQuizData} onAnswerSelect={vi.fn()} />)
  ...
  it('renders with many answer options', () => {
    ...
    render(<QuizContainer quizData={manyAnswersQuizData} onAnswerSelect={vi.fn()} />)
  ...
  it('handles answer selection changes correctly', () => {
    ...
    const { rerender } = render(
      <QuizContainer {...defaultProps} onAnswerSelect={mockOnAnswerSelect} selectedAnswer="paris" />
    )
    
    // Change selected answer
    rerender(
      <QuizContainer {...defaultProps} onAnswerSelect={mockOnAnswerSelect} selectedAnswer="london" />
    )
  ...
  it('generates unique keys for answer buttons', () => {
    ...
    const buttons = container.querySelectorAll('button, [role="button"], [tabindex]')
