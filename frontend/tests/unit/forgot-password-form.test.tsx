...
describe('ForgotPasswordForm', () => {
  ...
  it('renders the form elements', () => {
    ...
    expect(screen.getByRole('button', { name: /send reset email/i })).toBeDefined()
  ...
  it('disables submit button when loading is true', () => {
    ...
    const submitButton = screen.getByRole('button', { name: /sending reset email/i })
    expect(submitButton.getAttribute('disabled')).toBe('')
  })
  ...
  it('shows loading state with spinner when loading is true', () => {
    ...
    expect(screen.getByText('Sending Reset Email...').closest('button')?.querySelector('svg')).toBeDefined()
  })
