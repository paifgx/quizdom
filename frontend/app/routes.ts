...
export default [
  ...
  layout('layouts/main-layout.tsx', [
    ...
    route('/quiz/:quizId/quiz-game', 'routes/quiz-game.tsx', {
      id: 'quiz-quiz-game',
    }),
    route('/join/:sessionId', 'routes/join.$sessionId.tsx'),
    route('/duell', 'routes/duell.tsx'),
    route('/duell/erstellen', 'routes/duell-erstellen.tsx'),
    route('/duell/beitreten', 'routes/duell-beitreten.tsx'),
