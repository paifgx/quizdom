...
// Nine-slice quiz components
export { NineSlicePanel } from './nine-slice-quiz/nine-slice-panel';
export { QuizButton } from './nine-slice-quiz/quiz-button';
export { QuizContainer } from './nine-slice-quiz/quiz-container';
