          ...
          <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 border border-gray-700">
            <div className="text-center">
              <p className="text-3xl font-bold text-yellow-400">
                {
                  sampleUsers.filter(u => daysSinceLastLogin(u.lastLogin) > 30)
                    .length
                }
              </p>
        ...
        <div className="bg-gray-800 bg-opacity-50 rounded-xl border border-gray-700 overflow-hidden">
            ...
            <table className="w-full">
              <thead className="bg-gray-700 bg-opacity-50">
                <tr className="text-left">
                  <th className="px-6 py-3 text-gray-300 font-medium">
                    Benutzer
                  </th>
          ...
          {filteredUsers.length === 0 && (
            <div className="p-12 text-center">
              ...
              />
              <p className="text-gray-400 text-lg">Keine Benutzer gefunden.</p>
              <p className="text-gray-500 text-sm mt-2">
                Ändern Sie Ihre Suchkriterien oder fügen Sie neue Benutzer
                hinzu.
              </p>
            </div>
          )}
