...
export default function QuizzesPage() {
  ...
  const availableQuizzes: Quiz[] = [
    {
      ...
      description:
        'Testen Sie Ihr Wissen über die fundamentalen Gesetze der Physik',
  ...
  const getAverageScore = () => {
    const completedQuizzes = availableQuizzes.filter(
      quiz => quiz.completed && quiz.score
    );
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-300 text-lg max-w-2xl mx-auto">
            Entdecken Sie spannende Quizzes aus verschiedenen Kategorien und
        ...
        {sortedQuizzes.length === 0 && (
          <div className="text-center py-12">
            ...
            />
            <p className="text-gray-400 text-lg">Keine Quizzes gefunden.</p>
