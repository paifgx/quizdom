...
export function meta() {
  return [
    ...
    { name: 'description', content: 'Verwalten Sie Quiz-Fragen und -Kategorien.' },
  ];
}
          ...
          <div className="bg-gray-800 bg-opacity-50 rounded-xl border border-gray-700 overflow-hidden">
                  ...
                  <div className="flex items-start justify-between">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-4">
                        {question.answers.map((answer, index) => (
                          ...
                          >
                            {answer.text}
                            {answer.isCorrect && (
                              <img src="/buttons/Accept.png" alt="Correct" className="inline h-4 w-4 ml-2" />
                            )}
                          </div>
                        ))}
                      </div>
                    ...
                    <div className="flex space-x-2 ml-4">
                      <button
                        ...
                        title="Bearbeiten"
                      >
                        <img src="/buttons/Settings.png" alt="Edit" className="h-5 w-5" />
                      </button>
                      <button
                        className="p-2 text-red-400 hover:bg-red-400 hover:bg-opacity-20 rounded-lg transition-colors duration-200"
                        title="Löschen"
                      >
                        <img src="/buttons/Delete.png" alt="Delete" className="h-5 w-5" />
                      </button>
                    </div>
                  </div>
                </div>
            ...
            {filteredQuestions.length === 0 && (
              <div className="p-12 text-center">
                <img src="/buttons/Filter.png" alt="No results" className="h-16 w-16 mx-auto mb-4 opacity-50" />
            ...
            <div className="flex justify-center mt-8">
              <nav className="flex space-x-2">
                <button className="px-4 py-2 bg-gray-700 text-gray-300 rounded-lg hover:bg-gray-600 transition-colors duration-200">
                  <img src="/buttons/Left.png" alt="Previous" className="h-4 w-4" />
                </button>
