      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-300 text-lg">
              Willkommen zurück, {user?.username}! Hier ist eine Übersicht über das System.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 border border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-300 text-sm font-medium">Benutzer gesamt</p>
                ...
                <div className="p-3 bg-[#FCC822] bg-opacity-20 rounded-lg">
                  <img src="/avatars/player_male_with_greataxe.png" alt="Users" className="h-8 w-8" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 border border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-300 text-sm font-medium">Aktive Benutzer</p>
                  <p className="text-3xl font-bold text-[#FCC822]">
            ...
            <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 border border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-300 text-sm font-medium">Quizzes gesamt</p>
                  <p className="text-3xl font-bold text-[#FCC822]">
                ...
                <div className="p-3 bg-blue-500 bg-opacity-20 rounded-lg">
                  <img src="/badges/badge_book_1.png" alt="Quizzes" className="h-8 w-8" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 border border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-gray-300 text-sm font-medium">Fragen gesamt</p>
                  <p className="text-3xl font-bold text-[#FCC822]">
                ...
                <div className="p-3 bg-purple-500 bg-opacity-20 rounded-lg">
                  <img src="/buttons/Filter.png" alt="Questions" className="h-8 w-8" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 border border-gray-700">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-green-400 text-sm">+2.3% vs. letzten Monat</p>
                </div>
                <div className="p-3 bg-[#FCC822] bg-opacity-20 rounded-lg">
                  <img src="/stars/star_full.png" alt="Score" className="h-8 w-8" />
                </div>
              </div>
            </div>
            ...
            <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 border border-gray-700">
              <div className="flex items-center justify-between">
                ...
                <div className="p-3 bg-green-500 bg-opacity-20 rounded-lg">
                  <img src="/buttons/Settings.png" alt="System" className="h-8 w-8" />
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 grid grid-cols-1 md:grid-cols-4 gap-4">
            <button className="btn-gradient p-4 rounded-xl text-center font-medium transition-all duration-200 hover:scale-105">
              <img src="/buttons/Add.png" alt="Add" className="h-6 w-6 mx-auto mb-2" />
              Neue Frage hinzufügen
            </button>
            <button className="btn-gradient p-4 rounded-xl text-center font-medium transition-all duration-200 hover:scale-105">
              <img src="/avatars/ai_assistant_wizard.png" alt="Users" className="h-6 w-6 mx-auto mb-2" />
              Benutzer verwalten
            </button>
            <button className="btn-gradient p-4 rounded-xl text-center font-medium transition-all duration-200 hover:scale-105">
              <img src="/buttons/Settings.png" alt="Settings" className="h-6 w-6 mx-auto mb-2" />
              System-Einstellungen
            </button>
            <button className="btn-gradient p-4 rounded-xl text-center font-medium transition-all duration-200 hover:scale-105">
              <img src="/buttons/Filter.png" alt="Reports" className="h-6 w-6 mx-auto mb-2" />
              Berichte erstellen
            </button>
          </div>
        </div>
