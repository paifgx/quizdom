...
export function meta() {
  return [
    ...
    { name: 'description', content: 'Wählen Sie aus verschiedenen spannenden Spielmodi.' },
  ];
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 text-lg max-w-2xl mx-auto">
              Wählen Sie aus verschiedenen spannenden Spielmodi und stellen Sie Ihr Wissen unter Beweis.
            </p>
          </div>
              ...
              >
                <div className="text-center">
                  ...
                  <div className="space-y-2 text-sm text-gray-400">
                    <p>
                      <span className="font-medium">Schwierigkeit:</span> {mode.difficulty}
                    </p>
                    <p>
                      <span className="font-medium">Belohnungen:</span> {mode.rewards}
                    </p>
                  </div>
