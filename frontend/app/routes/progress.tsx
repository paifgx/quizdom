...
export function meta() {
  return [
    ...
    { name: 'description', content: 'Verfolgen Sie Ihren Fortschritt und Ihre Erfolge.' },
  ];
}
...
export default function ProgressPage() {
  ...
  const levelProgress = Math.round((stats.experiencePoints / stats.nextLevelXP) * 100);
      ...
      <div className="min-h-screen bg-[#061421]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="bg-gray-800 bg-opacity-50 rounded-xl p-6 mb-12">
            <h2 className="text-2xl font-bold text-[#FCC822] mb-4">Level Fortschritt</h2>
          ...
          {/* Achievements */}
          <div className="mb-12">
            <h2 className="text-2xl font-bold text-[#FCC822] mb-6">Errungenschaften</h2>
