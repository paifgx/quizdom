...
def upgrade() -> None:
    ...
    op.create_table(
        'gamesession',
        sa.Column('id', sa.Integer(), nullable=True),
        sa.Column('mode', sa.Enum('solo', 'duel', 'team',
                  name='gamemode'), nullable=False),
        sa.Column('status', sa.Enum('active', 'paused',
                  'finished', name='gamestatus'), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column('difficulty', sa.Enum('1', '2', '3', '4',
                  '5', name='difficulty'), nullable=False),
    ...
    op.create_index(op.f('ix_question_topic_id'),
                    'question', ['topic_id'], unique=False)
    ...
    op.create_index(op.f('ix_answer_question_id'),
                    'answer', ['question_id'], unique=False)
    ...
    op.create_index(op.f('ix_playeranswer_game_session_id'),
                    'playeranswer', ['game_session_id'], unique=False)
    ...
    op.create_index(op.f('ix_userbadge_badge_id'),
                    'userbadge', ['badge_id'], unique=False)
    op.create_index(op.f('ix_userbadge_user_id'),
                    'userbadge', ['user_id'], unique=False)
    ...
    op.create_table(
        ...
        sa.Column('mode', sa.Enum('solo', 'duel', 'team',
                  name='gamemode'), nullable=False),
        sa.Column('period', sa.Enum('daily', 'weekly', 'monthly',
    ...
    op.create_index(op.f('ix_leaderboardentry_leaderboard_id'),
                    'leaderboardentry', ['leaderboard_id'], unique=False)
    op.create_index(op.f('ix_leaderboardentry_user_id'),
                    'leaderboardentry', ['user_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('quiz')
    op.drop_index(op.f('ix_leaderboardentry_user_id'),
                  table_name='leaderboardentry')
    op.drop_index(op.f('ix_leaderboardentry_leaderboard_id'),
                  table_name='leaderboardentry')
    ...
    op.drop_table('badge')
    op.drop_index(op.f('ix_playeranswer_game_session_id'),
                  table_name='playeranswer')
