...
def upgrade() -> None:
    ...
    op.create_table(
        "wallet",
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column("wisecoins", sa.Integer(), nullable=False, server_default="0"),
    ...
    op.create_table(
        ...
        sa.Column(
            "type", sa.Enum("verify", "reset", name="emailtokentype"), nullable=False
        ),
    ...
    op.create_index(op.f("ix_emailtokens_token"), "emailtokens", ["token"], unique=True)
    op.create_index(
        op.f("ix_emailtokens_user_id"), "emailtokens", ["user_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_auditlogs_actor_id"), "auditlogs", ["actor_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column("hearts_left", sa.Integer(), nullable=False, server_default="3"),
    ...
    op.create_table(
        ...
        sa.Column(
            "media_type", sa.Enum("png", "gif", "mp3", name="mediatype"), nullable=False
        ),
        sa.ForeignKeyConstraint(
            ["question_id"],
            ["question.id"],
    ...
    op.create_index(
        op.f("ix_questionmedia_question_id"),
        "questionmedia",
        ["question_id"],
        unique=False,
    )
    ...
    op.add_column(
        "playeranswer",
        sa.Column("answer_time_ms", sa.Integer(), nullable=False, server_default="0"),
    )

    # Rename game_session_id to session_id in playeranswer
    op.alter_column("playeranswer", "game_session_id", new_column_name="session_id")
...
def downgrade() -> None:
    ...
    op.add_column("gamesession", sa.Column("user_id", sa.Integer(), nullable=True))
    ...
    op.drop_index(op.f("ix_questionmedia_question_id"), table_name="questionmedia")
